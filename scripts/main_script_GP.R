...
# Set paths
setwd("/home/lucas/Escritorio/CFR_calculation-master/")
...
inference_data <- cases_known_convolution(iso_arg, jhu_data, cfr_baseline) %>%
    dplyr::filter(date > "2020-08-01" & date < "2020-12-01")
...
write.csv(prediction, file = "/home/lucas/Escritorio/CFR/data/prediction_CHL.csv", row.names = FALSE)
saveRDS(prediction, file = "/home/lucas/Escritorio/CFR/data/result_CHL.rds")  
