...
# Source functions 
source("/home/lucas/Escritorio/CFR_calculation-master/R/scale_cfr.R")
source("/home/lucas/Escritorio/CFR_calculation-master/R/delay_distributions.R")
source("/home/lucas/Escritorio/CFR_calculation-master/R/table_of_estimates.R")
...
reportDataFinal <- finalRes %>%
  ...
  dplyr::ungroup() %>% #Aquí tengo una duda con el cambio realizado.
...
# saving the output
saveRDS(reportDataFinal, file = "/home/lucas/Escritorio/CFR_calculation-master/data/reportDataFinal.rds")
write.csv(finalRes, file = "/home/lucas/Escritorio/CFR_calculation-master/data/finalRes.csv", row.names = FALSE)
# # # write.csv(Resultados, file = paste("/home/lucas/Escritorio/CFR_calculation-master/data/",allTogetherClean$country[1],".csv",sep=""), row.names = FALSE)
