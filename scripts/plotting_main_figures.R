...
path <- '/home/shared/victorosores/cfr_underreporting/'


library(patchwork)
source(paste(path,"R/data_helper_functions.R",sep=""))
source(paste(path,"R/plotting_helper_functions.R",sep=""))
source(paste(path,"R/plotting_functions.R",sep=""))
...
# # # png(paste(path,"figures/figure_S4.png",sep=""), width = 10, height = 8, units = "in", res = 100)
# # # fontsize1 <- 1
# # # par(mar = c(3, 3, 3, 3))
# # # par(oma = c(2, 2, 2, 2))
# # # par(mfrow = c(3, 3))
...
# # # ggplot2::ggsave("/home/lucas/Escritorio/covid_underreporting-master/figures/figure_S5.png",
# # #                 plot = figure2, 
# # #                 width = 16,
# # #                 height = 8,
# # #                 units = "in")
...
# # # # # # figure3 <- figure_3_fun() # No es posible sacar figura 6 faltan datos.
# # # # # # ggplot2::ggsave(
# # # # # #   "/home/lucas/Escritorio/covid_underreporting-master/figures/figure_S6.png",
# # # # # #   plot = figure3, 
# # # # # #   width = 10,
# # # # # #   height = 5,
# # # # # #   units = "in")
...
# # # ggplot2::ggsave("/home/lucas/Escritorio/covid_underreporting-master/figures/figure_4.png",
# # #                 plot = figure4, 
# # #                 width = 10,
# # #                 height = 5,
# # #                 units = "in")
...
# # # ggplot2::ggsave(
# # #   "/home/lucas/Escritorio/covid_underreporting-master/figures/figure_S7.png",
# # #   plot = plotS1, 
# # #   width = 12,
# # #   height = 12,
# # #   units = "in")
...
# # #   ggplot2::facet_wrap(~country, scales = "free_y", ncol = 6) + 
# # # #   ggplot2::theme_minimal() +
# # #   ggplot2::theme(axis.text.x = ggplot2::element_text(size=5, angle=45)) +
# # #   ggplot2::labs(x = "Date", y = "Tests performed per new confirmed case")

# # # ggplot2::ggsave(
# # #   "/home/lucas/Escritorio/covid_underreporting-master/figures/figure_S2.png",
# # #   plot = plotS2, 
# # #   width = 12,
# # #   height = 12,
# # #   units = "in")
...
# # # ggplot2::ggsave("/home/lucas/Escritorio/covid_underreporting-master/figures/figure_S3.png",
# # #                 plot = plot_s3, 
# # #                 width = 14,
# # #                 height = 7,
# # #                 units = "in")
